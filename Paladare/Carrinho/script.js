...
function renderItem(item, idPosicao) {
    ...
    <div class="products">
        ...
        <div>
            <label id="Observacaolb" for="Observacao"><i class="bi bi-chat-left-text-fill"></i>Alguma Observação?</label> <br>
            <textarea type="text" placeholder="Ex: Tirar a cebola, maionese á parte, etc." id="Observacao" cols="30" rows="1"></textarea>
        </div>
    </div>`
}
